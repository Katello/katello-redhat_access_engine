...
Gem::Specification.new do |s|
  s.name        = "katello-redhat-access-engine"
  s.version     = RedHatAccess::VERSION
  s.authors     = ["Katello"]
  s.email       = ["katello-devel@redhat.com"]
  s.homepage    = "https://github.com/Katello/katello-redhat-access-engine"
  s.licenses    = ["GPL-2"]
  ...
  s.files = Dir["{app,public,config,db,lib,vendor}/**/*"] + ["katello-redhat-access-engine.gemspec", "Rakefile", "README.rdoc"]
